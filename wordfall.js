...
class Word {
    constructor(text, colour = "lightblue", top, left, width, isCorrect = false) {
        this.text = text;
        this.colour = colour;
        this.top = top;
        this.left = left;
    ...
    drowWord = (multiplier) => {
        context.clearRect(this.left, this.top - multiplier - 1, this.width, this.height);
